...
//         this.query = this.query.find({ ...keyword }); return this;
//     }
//     filter() {
//         const queryCopy = { ...this.queryStr };    //   Removing some fields for category    const removeFields = ["keyword", "page", "limit"];
...
class ApiFeatures {
    ...
    filter() {
        ...
        const regax = /\b(gt|gte|lt|lte|in)\b/g
        queryStr = queryStr.replace(regax, (key) => `$${key}`);
        this.query = this.query.find(JSON.parse(queryStr));
        return this;
    }
